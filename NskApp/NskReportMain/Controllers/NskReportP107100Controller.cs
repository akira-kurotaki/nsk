...
using NskReportMain.ReportCreators.NSK_P107100;
...
{
    public class NskReportP107100Controller : ReportController
    {
        ...
        /// ロガー出力情報
        /// </summary>
        private static readonly string LOGGER_INFO_STR = "P107100_未納者リスト_制御処理";
        #endregion

        public NskReportP107100Controller(DbConnectionInfo dbInfo) : base(dbInfo)
        {
        }

        #region P107100_未納者リスト制御処理
        /// <summary>
        /// P107100_未納者リスト制御処理
        /// </summary>
        ...
        public ControllerResult ManageReports(string userId, string joukenId, string todofukenCd, string kumiaitoCd, string shishoCd, long? batchId)
        {
            ...
            try
            {
                ...
                var pModel = GetRealReportDataList(reportJoukens, kumiaitoCd, shishoCd);
                ...
                // 帳票出力処理を呼び出す。
                result = CreateP107100(reportJoukens, pModel, joukenId, kumiaitoCd, ref report);
        ...
        #region 「P107100_未納者リスト_制御処理」を作成するメソッド
        /// <summary>
        /// 「P107100_未納者リスト_制御処理」を作成するメソッド
        /// </summary>
        ...
        /// <returns>実行結果</returns>
        private ControllerResult CreateP107100(
            ...
            ref BaseSectionReport report)
        {
            // 実行結果
            var result = new ControllerResult();
            NSK_P107100Creator pCreator = new NSK_P107100Creator();
            ...
            // 出力レポートにP107100_未納者リスト_制御処理を入れる。
        ...
        private List<NSK_P107100Model> GetRealReportDataList(List<T01050バッチ条件> reportJoukens, string kumiaitoCd, string shishoCd)
        {
            // sql用定数定義
            ...
            return getJigyoDb<NskAppContext>().Database.SqlQueryRaw<NSK_P107100Model>(sql.ToString(), parameters.ToArray()).ToList();
        }
        #endregion
