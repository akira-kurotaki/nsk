...
{
    [Serializable]
    public class D105070Model : CoreViewModel
    {
        /// <summary>
        /// メッセージエリア1
        /// </summary>
        ...
        public string RuiKbnNm { get; private set; }
        #endregion
        ...
        /// 検索結果
        /// </summary>
        public D105070HikiukeSearchResult HikiukeSearchResult { get; set; } = new();
        #endregion
        ...
        /// 計算結果
        /// </summary>
        public D105070CalcResult CalcResult { get; set; } = new();
        #endregion


        #region "組合員等毎設定"
        public D105070KumiaiintoSettei KumiaiintoSettei { get; set; } = new();
        #endregion


        #region "類別設定"
        public D105070RuibetsuSettei RuibetsuSettei { get; set; } = new();
        #endregion
        ...
        /// <returns></returns>
        public bool GetHikiukeKakutei(NskAppContext dbContext, D105070SessionInfo sessionInfo)
        {
