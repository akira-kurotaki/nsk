...
namespace NskWeb.Areas.F105.Models.D105030
{
    ...
    public interface ID105030Pager<T> where T : new()
    {
        /// <summary>
        /// 検索結果を取得する
        /// </summary>
        ...
        /// <returns></returns>
        public List<T> GetResult(NskAppContext dbContext, D105030SessionInfo sessionInfo);
        ...
        /// <returns></returns>
        public List<T> GetUpdateRecs(ref NskAppContext dbContext, D105030SessionInfo sessionInfo);
    }
    ...
    /// <typeparam name="T"></typeparam>
    [Serializable]
    public abstract class D105030Pager<T> : ID105030Pager<T> where T : new()
    {
        ...
        public void GetPageDataList(NskAppContext dbContext, D105030SessionInfo sessionInfo, int pageId)
        {
            // 検索結果をクリアする
            DispRecords = new();
        ...
        public void AddPageData()
        {
            // 新規行を追加する
            T newRow = new();
            if (newRow is D105030PagerRecord pagerRec)
            {
        ...
        public void DelPageData()
        {
            ...
            {
                if (rec is D105030PagerRecord pagerRec && pagerRec.CheckSelect)
                {
        ...
        private void UpdatePager(int pageId)
        {
            ...
            foreach (T rec in DispRecords)
            {
                if (rec is D105030PagerRecord pagerRec)
                {
        ...
        /// <param name="sessionInfo">セッション情報</param>
        /// <returns></returns>
        public abstract List<T> GetResult(NskAppContext dbContext, D105030SessionInfo sessionInfo);
        ...
        /// <param name="sessionInfo"></param>
        /// <returns></returns>
        public abstract List<T> GetUpdateRecs(ref NskAppContext dbContext, D105030SessionInfo sessionInfo);
