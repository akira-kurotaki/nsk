...
namespace NskWeb.Areas.F102.Controllers
{
    ...
    public class D102010Controller : CoreController
    {
        ...
        public ActionResult Init()
        {
            ...
            if (!ScreenSosaUtil.CanReference(F102Const.SCREEN_ID_D102010, HttpContext))
            {
            ...
            var updateKengen = ScreenSosaUtil.CanUpdate(F102Const.SCREEN_ID_D102010, HttpContext);
            ...
            // 初期表示情報をセッションに保存する
            SessionUtil.Set(F102Const.SESS_D102010, model, HttpContext);
            return View(F102Const.SCREEN_ID_D102010, model);
        }
        ...
        public ActionResult CreatBatchReport([Bind("TorikomiFilePath")] D102010Model form)
        {
            ...
            var model = SessionUtil.Get<D102010Model>(F102Const.SESS_D102010, HttpContext);
            ...
            BatchUtil.GetBatchYoyakuListParam param = new()
            {
                ...
                BatchNm = F102Const.BATCH_ID_NSK_102011B
            };
            // 総件数取得フラグ
            ...
            {
                // メッセージ表示して処理を中止する
                return Json(new { success = false, message = MessageUtil.Get("ME10019", "危険段階データ取込（危険段階別料率）") });
            }
            ...
            try
            {
                ...
                Syokuin.UserId,
                F102Const.SCREEN_ID_NSK_D102010,
                F102Const.BATCH_ID_NSK_102011B,
                strJoukenId,
                displayJouken,
                AppConst.FLG_OFF,
            ...
            return Json(new { success = true, message = MessageUtil.Get("MI00004", "危険段階データ取込（危険段階別料率）バッチの予約") });
        }
        #endregion
