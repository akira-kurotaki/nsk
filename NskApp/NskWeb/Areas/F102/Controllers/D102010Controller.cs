...
namespace NskWeb.Areas.F102.Controllers
{
    ...
    [AllowAnonymous]
    [Area("F102")]
    public class D102010Controller : CoreController
    {
        #region メンバー定数
        /// <summary>
        /// 画面ID(D2010)
        /// </summary>
        private static readonly string SCREEN_ID_D102010 = "D102010";

        /// <summary>
        /// セッションキー(D102010)
        /// </summary>
        private static readonly string SESS_D102010 = "D102010_SCREEN";
        /// <summary>
        /// 予約を実行した処理名
        /// </summary>
        private static readonly string D102010_REPORT_YOYAKU_SHORI_NM = "NSK_102010D";
        /// <summary>
        /// バッチ名
        /// </summary>
        private static readonly string D102010_BATCH_NM = "危険段階データ取込（危険段階別料率）（テキスト）";

        private readonly IWebHostEnvironment _webHostEnvironment;

        public D102010Controller(ICompositeViewEngine viewEngine, IWebHostEnvironment webHostEnvironment) : base(viewEngine)
        {
        ...
        public ActionResult Init()
        {
            ...
            if (!ScreenSosaUtil.CanReference(SCREEN_ID_D102010, HttpContext))
            {
            ...
            //// モデル初期化
            D102010Model model = new D102010Model
            {
                // 「ログイン情報」を取得する
                VSyokuinRecords = getJigyoDb<NskAppContext>().VSyokuins.Where(t => t.UserId == Syokuin.UserId).Single()
            };
            var updateKengen = ScreenSosaUtil.CanUpdate(SCREEN_ID_D102010, HttpContext);
            ...
            if (md != null)
            {
                model.D102010Info.SKyosaiMokutekiCd = md.SKyosaiMokutekiCd;
                model.D102010Info.SNensanHikiuke = md.SNensanHikiuke;
            ...
            // 初期表示情報をセッションに保存する
            SessionUtil.Set(SESS_D102010, model, HttpContext);
            return View(SCREEN_ID_D102010, model);
        }
        ...
        public ActionResult CreatBatchReport([Bind("TorikomiFilePath")] D102010Model form)
        {
            logger.Debug("START CreatBatchReport");
            var model = SessionUtil.Get<D102010Model>(SESS_D102010, HttpContext);
            ...
            try
            {
                ...
                Syokuin.UserId,
                D102010_REPORT_YOYAKU_SHORI_NM,
                D102010_BATCH_NM,
                strJoukenId,
                displayJouken,
                AppConst.FLG_OFF,
        ...
        private string IsPrivateCheckError(D102010Model form)
        {
        ...
        private void SetFormToModel(D102010Model form, D102010Model model)
        {
            // アップロードするファイル
        ...
        private string InsertTJouken(D102010Model model, string joukenId, string filePath, string fileHash)
        {
            // ユーザID
            var userId = Syokuin.UserId;
            // システム日時
