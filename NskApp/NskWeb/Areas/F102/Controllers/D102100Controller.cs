...
namespace NskWeb.Areas.F102.Controllers
{
    ...
    public class D102100Controller : CoreController
    {
        ...
        public ActionResult Init()
        {
            ...
            if (!ScreenSosaUtil.CanReference(F102Const.SCREEN_ID_D102100, HttpContext))
            {
            ...
            var updateKengen = ScreenSosaUtil.CanUpdate(F102Const.SCREEN_ID_D102100, HttpContext);
            ...
            // 初期表示情報をセッションに保存する
            SessionUtil.Set(F102Const.SESS_D102100, model, HttpContext);
            return View(F102Const.SCREEN_ID_D102100, model);
        }
        ...
        public ActionResult CreatBatchReport([Bind("TorikomiFilePath")] D102100Model form)
        {
            ...
            var model = SessionUtil.Get<D102100Model>(F102Const.SESS_D102100, HttpContext);
            ...
            BatchUtil.GetBatchYoyakuListParam param = new()
            {
                ...
                BatchNm = F102Const.BATCH_ID_NSK_102101B
            };
            // 総件数取得フラグ
            ...
            {
                // メッセージ表示して処理を中止する
                return Json(new { success = false, message = MessageUtil.Get("ME10019", "危険段階データ取込（組合員等別危険段階区分）") });
            }
            ...
            try
            {
                ...
                Syokuin.UserId,
                F102Const.SCREEN_ID_NSK_D102100,
                F102Const.BATCH_ID_NSK_102101B,
                strJoukenId,
                displayJouken,
                AppConst.FLG_OFF,
