...
using static NskWeb.Areas.F107.Models.D107050.D107050EntryCondition;

namespace NskWeb.Areas.F107.Models.D107050
{
    /// <summary>
    /// 消込み処理(還付・自動)(インタフェース）画面項目モデル
    /// </summary>
    [Serializable]
    public class D107050EntryCondition
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public D107050EntryCondition()
        {
        ...
        public D107050EntryCondition(Syokuin syokuin, List<Shisho> shishoList)
        {
        }
