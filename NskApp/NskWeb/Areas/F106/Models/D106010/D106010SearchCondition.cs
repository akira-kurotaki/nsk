...
using static NskWeb.Areas.F106.Models.D106010.D106010SearchCondition;

namespace NskWeb.Areas.F106.Models.D106010
{
    /// <summary>
    /// 引受計算処理（水稲）画面項目モデル（検索条件部分）
    /// </summary>
    [Serializable]
    public class D106010SearchCondition
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public D106010SearchCondition()
        {
        ...
        public D106010SearchCondition(Syokuin syokuin, List<Shisho> shishoList)
        {
        }
