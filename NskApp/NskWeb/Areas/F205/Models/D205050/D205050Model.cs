...
namespace NskWeb.Areas.F205.Models.D205050
{
    [Serializable]
    public class D205050Model : CoreViewModel
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public D205050Model(Syokuin syokuin, List<Shisho> shishoList)
        {
            this.VSyokuinRecords = new VSyokuin();
            this.D205050Info = new NSKPortalInfoModel();
            this.TodofukenDropDownList = new TodofukenDropDownList("D205050", syokuin, shishoList);
        }
        ...
        public NSKPortalInfoModel D205050Info { get; set; }
