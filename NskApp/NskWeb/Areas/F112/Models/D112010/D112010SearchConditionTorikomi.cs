...
using static NskWeb.Areas.F112.Models.D112010.D112010SearchConditionTorikomi;
...
namespace NskWeb.Areas.F112.Models.D112010
{
    ...
    /// </summary>
    [Serializable]
    public class D112010SearchConditionTorikomi
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public D112010SearchConditionTorikomi()
        {
        ...
        public D112010SearchConditionTorikomi(Syokuin syokuin, List<Shisho> shishoList)
        {
        ...
        /// </summary>
        [Display(Name = "検索条件")]
        public D112010SearchConditionTorikomi SearchCondition { get; set; }
        ...
        public DateTime? TorikomiDateFrom { get; set; }
        ...
        [Display(Name = "受入日（終了）")]
        [DataType(DataType.Date)]
        public DateTime? TorikomiDateTo { get; set; }

        /// <summary>
        /// 受入ユーザID
        /// </summary>
        [Display(Name = "受入ユーザID")]
        public string TorikomiUserId { get; set; }

        /// <summary>
        /// 受入ユーザID
        /// </summary>
        [Display(Name = "受入ユーザID")]
        public string TorikomiTaishoData { get; set; }
