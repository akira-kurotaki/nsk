...
namespace NskAppModelLibrary.Models
{
    ...
    public class T23090調整班平均単収差 : ModelBase
    {
        ...
        /// </summary>
        [Column("調整検見単収合計")]
        public Decimal? 調整検見単収合計 { get; set; }

        /// <summary>
        /// 調整筆の抜取単収合計
        /// </summary>
        [Column("調整筆の抜取単収合計")]
        public Decimal? 調整筆の抜取単収合計 { get; set; }

        /// <summary>
        /// 調整実測単収合計
        /// </summary>
        [Column("調整実測単収合計")]
        public Decimal? 調整実測単収合計 { get; set; }

        /// <summary>
        /// 調整実測筆の調整検見単収合計
        /// </summary>
        [Column("調整実測筆の調整検見単収合計")]
        public Decimal? 調整実測筆の調整検見単収合計 { get; set; }
