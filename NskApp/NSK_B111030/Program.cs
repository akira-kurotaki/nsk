...
using NSK_P111030.Controllers;
using System.Text;

namespace NSK_B111030
{
    /// <summary>
    /// 交付金変更内訳書（別紙）
    /// </summary>
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                using (NskAppContext dbContext = new(dbInfo.ConnectionString, dbInfo.DefaultSchema, ConfigUtil.GetInt(Core.CoreConst.COMMAND_TIMEOUT)))
                {
                    ...
                    using (var nsk111030PController = new NSK_111030PController(dbInfo))
                    {
                        controllerResult = nsk111030PController.ManageReports(dbContext, hikisu.ToArray());
                    }
